...
var VoTien = 2;
        ...
        self.assertTrue(TestChecker.test(input, "Redeclared Variable: VoTien", self.idx))
...
const VoTien = 2;
        ...
        self.assertTrue(TestChecker.test(input, "Redeclared Constant: VoTien", self.idx))
...
func VoTien () {return;}
        ...
        self.assertTrue(TestChecker.test(input, "Redeclared Function: VoTien", self.idx))
...
var getInt = 1;
        ...
        self.assertTrue(TestChecker.test(input, "Redeclared Variable: getInt", self.idx))
...
type TIEN struct {
    ...
    TIEN float;
        ...
        self.assertTrue(TestChecker.test(input, "Redeclared Field: TIEN", self.idx))
...
type TIEN struct {
    Votien int;
        ...
        self.assertTrue(TestChecker.test(input, "Redeclared Method: getInt", self.idx))
...
type VoTien interface {
    ...
    VoTien (a int);
        ...
        self.assertTrue(TestChecker.test(input, "Redeclared Prototype: VoTien", self.idx))
...
func Votien (a, a int) {return;}
        ...
        self.assertTrue(TestChecker.test(input, "Redeclared Parameter: a", self.idx))
...
func Votien (b int) {
    ...
    const a = 1;
        ...
        self.assertTrue(TestChecker.test(input, "Redeclared Constant: a", self.idx))
...
func Votien (b int) {
    for var a = 1; a < 1; a += 1 {
        ...
        self.assertTrue(TestChecker.test(input, "Redeclared Constant: a", 412))
